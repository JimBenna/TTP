...
$SoftToDownload = @("Seatbelt.exe","Rubeus.exe","SauronEye.exe","SharpKatz.exe","BetterSafetyKatz.exe","Moriarty.exe","SharpEDRChecker.exe","Snaffler.exe","SharpUp.exe","PurpleSharp.exe");
